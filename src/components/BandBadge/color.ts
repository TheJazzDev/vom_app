...
export const getBandColor = (
  ...
  const bandColorMap: Record<string, any> = {
    [Bands.Choir]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#F3E8FF] dark:shadow-[#2E1065]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#E9D5FF] dark:shadow-[#2E1065]',
      },
      glow: {
        container: 'bg-[#E9D5FF] dark:bg-[#4C1D95]',
        text: 'text-[#6B21A8] dark:text-[#E9D5FF]',
    ...
    [Bands.LoveDevine]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#D1FAE5] dark:shadow-[#064E3B]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#A7F3D0] dark:shadow-[#064E3B]',
      },
      glow: {
        container: 'bg-[#A7F3D0] dark:bg-[#064E3B]',
        text: 'text-[#065F46] dark:text-[#A7F3D0]',
    ...
    [Bands.YouthFellowship]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#E0E7FF] dark:shadow-[#312E81]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#C7D2FE] dark:shadow-[#312E81]',
      },
      glow: {
        container: 'bg-[#C7D2FE] dark:bg-[#312E81]',
        text: 'text-[#3730A3] dark:text-[#C7D2FE]',
    ...
    [Bands.Deborah]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#FEE2E2] dark:shadow-[#7F1D1D]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#FECACA] dark:shadow-[#7F1D1D]',
      },
      glow: {
        container: 'bg-[#FECACA] dark:bg-[#7F1D1D]',
        text: 'text-[#991B1B] dark:text-[#FECACA]',
    ...
    [Bands.Daniel]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#DBEAFE] dark:shadow-[#1E3A8A]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#BFDBFE] dark:shadow-[#1E3A8A]',
      },
      glow: {
        container: 'bg-[#BFDBFE] dark:bg-[#1E3A8A]',
        text: 'text-[#1E40AF] dark:text-[#BFDBFE]',
    ...
    [Bands.QueenEsther]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#FCE7F3] dark:shadow-[#831843]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#FBCFE8] dark:shadow-[#831843]',
      },
      glow: {
        container: 'bg-[#FBCFE8] dark:bg-[#831843]',
        text: 'text-[#9D174D] dark:text-[#FBCFE8]',
    ...
    [Bands.GoodWomen]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#FFEDD5] dark:shadow-[#7C2D12]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#FED7AA] dark:shadow-[#7C2D12]',
      },
      glow: {
        container: 'bg-[#FED7AA] dark:bg-[#7C2D12]',
        text: 'text-[#9A3412] dark:text-[#FED7AA]',
    ...
    [Bands.Warden]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#FEF3C7] dark:shadow-[#78350F]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#FDE68A] dark:shadow-[#78350F]',
      },
      glow: {
        container: 'bg-[#FDE68A] dark:bg-[#78350F]',
        text: 'text-[#92400E] dark:text-[#FDE68A]',
    ...
    [Bands.ChildrenMinistry]: {
      default: {
        ...
        shadow: 'shadow-sm shadow-[#E0F2FE] dark:shadow-[#0C4A6E]',
      },
      gradient: {
        container:
        ...
        shadow: 'shadow-[#BAE6FD] dark:shadow-[#0C4A6E]',
      },
      glow: {
        container: 'bg-[#BAE6FD] dark:bg-[#0C4A6E]',
        text: 'text-[#075985] dark:text-[#BAE6FD]',
  ...
  const defaultColors = {
    default: {
      ...
      shadow: 'shadow-sm shadow-gray-100 dark:shadow-gray-900',
    },
    gradient: {
      container:
