  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center mb-2">
        ...
        <Text variant="body">{formatDate(data.date)}</Text>
      </View>
  ...
  return (
    <View className="mt-2 mb-5" id="top-section">
      ...
      <View className="border-l-4 border-cyan-400 pl-4 mb-1">
        <InfoRow variant="h6" label="Date" value={formatDate(data.date)} />
      </View>
  ...
  return (
    ...
    >
      <Text
        variant="h4"
        color="heading"
        className="text-center tracking-widest mb-3 uppercase"
      >
        {data.type} SERVICE PROGRAMME
      </Text>
