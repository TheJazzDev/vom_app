...
const comingSoonConfigs: Record<string, ComingSoonConfig> = {
  bibleStudy: {
    ...
    description: 'Dive deeper into God\'s Word with interactive study sessions and discussions',
  ...
  prayerRequest: {
    ...
    description: 'Submit and share prayer requests with our loving church for spiritual support',
  ...
  recentSermons: {
    ...
    description: 'Access recent sermons and messages to strengthen your faith and spiritual growth',
  ...
  testimonies: {
    ...
    description: 'Share and read inspiring testimonies of God\'s goodness and faithfulness in our lives',
  ...
  events: {
    ...
    description: 'Stay updated with upcoming church events, fellowship activities, and community gatherings',
  ...
  return (
    <View style={{
      ...
      <Animated.View style={{
        ...
        height: 40,
        borderRadius: 20,
        backgroundColor: isDark ? `${config.secondaryColor}25` : `${config.secondaryColor}40`,
      ...
      <Animated.View style={{
        ...
        height: 80,
        borderRadius: 40,
        backgroundColor: isDark ? `${config.primaryColor}25` : `${config.primaryColor}40`,
...
// Example usage component for Bible Study
const BibleStudy = () => {
  return <ComingSoon config={comingSoonConfigs.bibleStudy} />;
};
