...
export default function ProfileIndex() {
  ...
  const { currentUser, memberId } = useAuthSlice();
    ...
    >
      ...
      <View className="relative">
        ...
        >
          ...
          {/* Profile Info */}
          <View className="flex-row items-end relative z-10">
            <View className="relative mr-4">
              ...
              {currentUser?.verified && (
                <View className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-600 rounded-full items-center justify-center border-2 border-white">
      ...
      <View className="px-4 -mt-6 relative z-10 mb-6">
        ...
        >
          <View className="flex-row justify-betwee">
          ...
          >
            ...
            {currentUser?.band && currentUser.band.length > 0 && (
              <View>
                ...
                <View className="flex-row flex-wrap gap-2">
                  {currentUser.band.map((band, index) => (
