...
import { getWeeklyActivities } from '@/src/services/activities/weeklyActivities';
...
export default function WeeklyActivities() {
  ...
  const loadProgrammes = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to load weekly activities');
    } finally {
      setIsLoading(false);
    }
  }, []);
    ...
    >
      <View gradient className="flex-1 px-4 pt-4">
        ...
        <Text variant="body" className="mb-4" style={{ color: theme.muted }}>
          Recurring weekly church activities
        </Text>
